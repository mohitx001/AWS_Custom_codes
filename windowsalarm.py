...
def create_alarm(region, instance_id):
    # Create session
    ...
    sns_customer = 'arn:aws:sns:eu-west-1:774391337868:774391337868-eu-west-1-modops-alerts'
    ...
    memory_alarm_name = f"rackspace-modops-low-memory-alert-Shared-{instance_name}-{instance_id}"
...
if __name__ == "__main__":
    ...
    create_alarm(args.region, args.instance_id)
